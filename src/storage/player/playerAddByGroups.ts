...
import { PLAYER_COLLECTION, FREQUENCY_COLLECTION } from '@storage/storageConfig';
...
export async function playerAddByGroup(newPlayer: PlayerStorageDTO, group: string, frequency: string) {
    ...
    try{
        ...
        const storedPlayers = await playersGetByGroup(group, frequency);
